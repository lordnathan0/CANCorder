...
public class Translator {
	...
	public final void translate(Bike bike, CanFrame frame) {
		...
		ArrayList<Signal<String, Integer, Integer, Integer>> dbfSignals = dbfMap.dbfMap.get(messageID);
		for (Signal<String, Integer, Integer, Integer> signal : dbfSignals) {
